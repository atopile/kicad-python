...
CANONICAL_LAYER_NAMES = {
    ...
    BoardLayer.BL_B_Adhes: "B.Adhesive",
    BoardLayer.BL_F_Adhes: "F.Adhesive",
    BoardLayer.BL_B_Paste: "B.Paste",
    BoardLayer.BL_F_Paste: "F.Paste",
    BoardLayer.BL_B_SilkS: "B.Silkscreen",
    BoardLayer.BL_F_SilkS: "F.Silkscreen",
    BoardLayer.BL_B_Mask: "B.Mask",
    BoardLayer.BL_F_Mask: "F.Mask",
    BoardLayer.BL_Dwgs_User: "User.Drawings",
    BoardLayer.BL_Cmts_User: "User.Comments",
    BoardLayer.BL_Eco1_User: "User.Eco1",
    BoardLayer.BL_Eco2_User: "User.Eco2",
    BoardLayer.BL_Edge_Cuts: "Edge.Cuts",
    BoardLayer.BL_Margin: "Margin",
    BoardLayer.BL_F_CrtYd: "F.Courtyard",
    BoardLayer.BL_B_CrtYd: "B.Courtyard",
